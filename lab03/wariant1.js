db.createCollection("companies", {
  ...
  // Schema dla kolekcji reservations (rezerwacje)
  ...
  db.reservations.insertOne({
    userId: userId1,
    tourId: tourId2,
    bookingDate: ISODate("2025-02-15"),
    status: "confirmed",
    participantsCount: 1,
    totalPrice: 5000,
    paymentStatus: "paid",
    specialRequests: "Prośba o późny check-out"
  });
  ...
  db.tours.deleteOne({ _id: tourId });
  
  db.reservations.find({ tourId: tourId });
